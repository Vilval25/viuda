...
class LifeOfferMsg(BaseModel):
    ...
    offer_type:
      ...
      public_auction – public auction to sell `amount` lives starting at `price`
    ...
    offer_type:  Literal["public_sell", "public_buy", "direct_sell", "direct_buy", "public_auction"]
    amount:      int
    price:       float
...
class PlaceBidMsg(BaseModel):
    type:      Literal["place_bid"]
    offer_id:  str
    bid_price: float

class GameReactionMsg(BaseModel):
    type:  Literal["game_reaction"]
    emoji: str
