...
class LifeOffer:
    id:          str
    from_nick:   str
    offer_type:  str           # public_sell | public_buy | direct_sell | direct_buy | public_auction
    amount:      int           # number of lives
    price:       float         # total price in S/.
    target_nick: Optional[str] # only for private offers
    highest_bidder: Optional[str] = None # only for auction offers
            ...
            "life_offers": [
                {
                    ...
                    "highest_bidder": o.highest_bidder,
