...
export function useGameSocket() {
  ...
  const [gameReaction, setGameReaction] = useState(null)
  ...
  const placeBid = useCallback((offer_id, bid_price) =>
    send('place_bid', { offer_id, bid_price }), [send])
